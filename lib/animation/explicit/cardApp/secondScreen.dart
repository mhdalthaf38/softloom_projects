...
class CardFetails extends StatefulWidget {
  const CardFetails({super.key});

  @override
  State<CardFetails> createState() => _CardFetailsState();
}

class _CardFetailsState extends State<CardFetails>
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Center(
                    child: Hero(tag: 'taged', child: VerticalFlipCard())),
              ),
              Padding(
